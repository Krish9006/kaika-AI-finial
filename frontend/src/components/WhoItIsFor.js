export default function WhoItIsFor() {
    return (
        <section className="py-12 md:py-16 px-6 md:px-12 relative bg-surface overflow-hidden">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="order-2 lg:order-1 relative min-h-[500px] lg:h-[600px] w-full flex flex-col lg:block items-center justify-center mt-12 lg:mt-0">
                    ...
                    <div className="relative w-full h-full max-w-[500px] flex flex-col gap-6 lg:block">
                        ...
                        {/* Creators: Top-Left */}
                        <div className="relative lg:absolute lg:top-6 lg:left-0 bg-surface p-6 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 w-full max-w-sm lg:max-w-[220px] z-20 hover:scale-105 transition-transform duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-100 mx-auto">
                        ...
                        <div className="relative lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 bg-surface p-8 rounded-[2.5rem] shadow-2xl shadow-indigo-200/40 border border-indigo-50 z-30 w-full max-w-sm lg:w-72 text-center hover:scale-105 transition-transform duration-500 hover:shadow-indigo-500/20 mx-auto order-first lg:order-none">
                            <div className="w-16 h-16 mx-auto bg-indigo-600 rounded-2xl flex items-center justify-center text-3xl text-background mb-6 shadow-xl shadow-indigo-600/30">
                                ✨
                            </div>
                        ...
                        <div className="relative lg:absolute lg:bottom-6 lg:right-0 bg-surface p-6 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 w-full max-w-sm lg:max-w-[220px] z-20 hover:scale-105 transition-transform duration-500 delay-100 hover:shadow-2xl hover:shadow-purple-500/10 hover:border-purple-100 mx-auto">
                            <div className="flex items-center gap-3 mb-2">
                ...
                <div className="order-1 lg:order-2 text-center lg:text-left">
                    ...
                    <div className="space-y-4 max-w-lg mx-auto lg:mx-0 text-left">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-5 p-5 rounded-3xl bg-slate-50 border border-transparent hover:bg-surface hover:border-slate-200 hover:shadow-lg transition-all group cursor-default">
                                <div className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 font-bold text-sm group-hover:bg-indigo-600 group-hover:text-background transition-colors">
                                    ✓
                                </div>
