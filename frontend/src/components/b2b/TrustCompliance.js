            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="grid md:grid-cols-4 gap-8 mb-16">
                    <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 text-center">
                        <div className="w-12 h-12 mx-auto bg-surface rounded-xl shadow-sm flex items-center justify-center text-2xl mb-4 border border-slate-100">🔒</div>
                    ...
                    <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 text-center">
                        <div className="w-12 h-12 mx-auto bg-surface rounded-xl shadow-sm flex items-center justify-center text-2xl mb-4 border border-slate-100">🛡️</div>
                ...
                <div className="bg-slate-900 rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden shadow-2xl shadow-slate-900/20">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-surface/5 rounded-full blur-3xl pointer-events-none translate-x-1/2 -translate-y-1/2" />

                    <h3 className="text-2xl md:text-3xl font-bold text-background mb-4 relative z-10">Ready to start a pilot?</h3>
                    ...
                    <button className="bg-surface text-slate-900 hover:bg-indigo-50 px-8 py-3.5 rounded-full font-bold shadow-lg relative z-10">
                        Get in Touch
                    </button>
                </div>
            </div>
