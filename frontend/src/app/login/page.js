      ...
      <div className="md:w-1/2 bg-[#2D1B2D] text-white p-12 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="z-10 max-w-md mt-12 md:mt-0">
          <h1 className="text-4xl md:text-5xl font-serif font-medium mb-6 leading-tight">
            Welcome back to <span className="text-[#D4B483] italic">clarity.</span>
          </h1>
      ...
      <div className="md:w-1/2 p-8 md:p-16 flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 md:text-left">
            <h1 className="text-3xl font-serif font-bold text-[#2D1B2D] mb-2">Welcome Back</h1>
            <p className="text-[#2D1B2D]/60">Enter your details to sign in.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-sm font-bold text-[#2D1B2D]/70 uppercase tracking-wide">Password</label>
                <Link href="/forgot-password" className="text-sm font-bold text-[#2D1B2D] hover:text-[#4A2B4A] transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <input
          ...
          <div className="mt-8 text-center text-[#2D1B2D]/60 font-medium">
            ...
            <Link href="/signup" className="text-[#2D1B2D] hover:text-[#4A2B4A] font-bold underline decoration-2 underline-offset-4 decoration-[#D4B483]">
              Sign up
            </Link>
          </div>
        </div>
