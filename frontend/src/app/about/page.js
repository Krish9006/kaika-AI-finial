        ...
        <main className="bg-[#F3EFE9] text-[#2D1B2D] min-h-screen">
            ...
            <nav className="flex justify-between items-center px-6 py-6 md:px-12">
                ...
                <div className="flex gap-6 text-sm font-medium">
                    <Link href="/how-it-works" className="hover:text-[#4A2B4A]">How it Works</Link>
                    <Link href="/login" className="hover:text-[#4A2B4A]">Login</Link>
                </div>
            </nav>
            ...
            <section className="py-20 px-6 md:px-12 bg-white">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    <div className="relative w-full aspect-[4/5] rounded-t-[15rem] overflow-hidden bg-[#2D1B2D]">
                        <Image
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#2D1B2D]/60 to-transparent"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-6 text-lg text-[#2D1B2D]/80 leading-relaxed font-light">
                            <p>
            ...
            {/* Values Section */}
            <section className="py-24 px-6 md:px-12 bg-[#2D1B2D] text-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <span className="text-xs uppercase tracking-[0.2em] text-[#D4B483] font-bold">
                            Our Core Values
                        </span>
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="text-center">
                            <div className="w-16 h-16 rounded-full bg-[#4A2B4A] flex items-center justify-center mx-auto mb-6 text-2xl">
                                ❤️
                            </div>
