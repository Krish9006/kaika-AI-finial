        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-background text-foreground">
            ...
            <div className="md:w-1/2 bg-foreground text-background p-12 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="z-10 max-w-md mt-12 md:mt-0">
                    <h1 className="text-4xl md:text-5xl font-serif font-medium mb-6 leading-tight">
                        Begin your journey to <span className="text-secondary italic">inner peace.</span>
                    </h1>
            ...
            <div className="md:w-1/2 p-8 md:p-16 flex items-center justify-center">
                <div className="w-full max-w-md">
                    <h2 className="text-3xl font-serif font-bold mb-8 text-foreground">Create Account</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-bold text-foreground/70 mb-2 uppercase tracking-wide">Full Name</label>
                            <input
                                type="text"
                                required
                                value={name}
                        ...
                        <div>
                            <label className="block text-sm font-bold text-foreground/70 mb-2 uppercase tracking-wide">Password</label>
                            <input
                                type="password"
                                required
                                value={password}
                    ...
                    <div className="mt-8 text-center text-foreground/60 font-medium">
                        ...
                        <Link href="/login" className="text-foreground hover:text-primary font-bold underline decoration-2 underline-offset-4 decoration-secondary">
                            Log in
                        </Link>
                    </div>
                </div>
